...
parser.add_argument("--load_dir", default='./task/GLUE/SST_2/', help="insert load directory name", type=str)
parser.add_argument("--save_dir", default='./task/GLUE/SST_2/dataset/', help="insert save dir name", type=str)
...
for example in file[1:]:
    datapoint = {}
    datapoint['pure_txt'] = example[0].lower()
