...
parser.add_argument("--load_dir", default='./task/GLUE/STS_B/', help="insert load directory name", type=str)
parser.add_argument("--save_dir", default='./task/GLUE/STS_B/dataset/', help="insert save dir name", type=str)
...
for example in file[1:]:
    datapoint = {}
    datapoint['sen1'] = example[7].lower()
    datapoint['sen2'] = example[8].lower()
    datapoint['label'] = float(example[9])
