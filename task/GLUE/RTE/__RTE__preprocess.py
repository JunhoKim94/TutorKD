...
parser.add_argument("--load_dir", default='./task/GLUE/RTE/', help="insert load directory name", type=str)
parser.add_argument("--save_dir", default='./task/GLUE/RTE/dataset/', help="insert save dir name", type=str)
